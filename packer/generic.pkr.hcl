// ================================================================
// File: packer/generic.pkr.hcl
// Purpose:
//   Provide the shared Proxmox ISO builder used by curated OS templates.
//
// Notes:
//   - Derived from the upstream proxmox-packer-templates project and
//     trimmed into the homelab delivery model.
//   - Environment-specific values are injected through local.auto.pkrvars.hcl.
// ================================================================
